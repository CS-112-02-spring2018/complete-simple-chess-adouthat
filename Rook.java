...
public class Rook extends ChessPiece{
	...
	public Rook(int row, int column, String pieceColor){
		super(row, column, "Rook", pieceColor);

	}

	public void move(int co1, int co2)throws ArrayIndexOutOfBoundsException{
		...
		try{
            ...
            else if (co2 < 8 && co2 >= 0 && co1 == this.getRow()) {
                if(board.getBoardTile(co1, co2).substring(1, 2).equals("K")){
                    System.out.println(this.getCurrentMove() + "Valid Move");
                    System.out.println("GAME OVER THE KING IS DEAD White Wins");
                    System.out.println(board.toString());
